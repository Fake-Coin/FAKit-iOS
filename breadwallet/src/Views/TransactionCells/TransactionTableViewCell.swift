...
class TransactionTableViewCell : UITableViewCell, Subscriber {
    ...
    func setTransaction(_ transaction: Transaction, isBtcSwapped: Bool, maxDigits: Int, isSyncing: Bool) {
        self.transaction = transaction
        transactionLabel.attributedText = transaction.descriptionString(isBtcSwapped: isBtcSwapped, maxDigits: maxDigits)
